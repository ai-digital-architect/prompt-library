---
post_title: "General-Purpose Prompt Template — OpenAI GPT-5.3 Codex"
author1: "Prompt Library Team"
post_slug: "10-openai-gpt-5-3-codex"
...
summary: >
  Prompt template for GPT-5.3 Codex: agentic coding scaffold with scope
  boundaries and verification steps. Deprecated — migrate to GPT-5.6 Sol.
post_date: "2026-03-03"
last_updated: "2026-07-25"
---

> **Status (July 2026):** GPT-5.3-Codex is no longer listed in OpenAI's model
> documentation and is deprecated — OpenAI's deprecation guidance points Codex-era models to the current generation. The replacement named in the earlier
